var createFile, equalArrayItems, equalGroups, from, fs, grunt, id, norm, path, spec, temp, to, updatePath, _ref;
...
_ref = require('./helper/equals'), equalArrayItems = _ref.equalArrayItems, equalGroups = _ref.equalGroups;
